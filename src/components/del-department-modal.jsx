...
function DelDepartmentModal({ onClose, isOpen, onOpenChange }) {
  ...
  const onSubmit = e => {
    ...
    let config = {
      ...
      url:
        getUrl() +
        `api/Regions/${regionSelectedKey}/Gates/${gateSelectedKey}/departments/${selectedKey}`,
...
export default DelDepartmentModal;
